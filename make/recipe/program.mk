...
_MTB_RECIPE__OPENOCD_ERASE_ARGS=$(_MTB_RECIPE__OPENOCD_SCRIPTS) $(_MTB_RECIPE__OPENOCD_QSPI) -c "set DEBUG_CERTIFICATE $(CY_DBG_CERTIFICATE_PATH)" -c \
					"$(_MTB_RECIPE__OPENOCD_QSPI_FLASHLOADER); $(_MTB_RECIPE__OPENOCD_INTERFACE) $(_MTB_RECIPE__OPENOCD_PROBE_SERIAL) transport select $(_MTB_RECIPE__PROBE_INTERFACE); $(_MTB_RECIPE__OPENOCD_TARGET) $(_MTB_RECIPE_OPENOCD_CUSTOM_COMMAND) $(_MTB_RECIPE_OPENOCD_ERASE)"
_MTB_RECIPE__OPENOCD_PROGRAM_ARGS=$(_MTB_RECIPE__OPENOCD_SCRIPTS) $(_MTB_RECIPE__OPENOCD_QSPI) -c "set DEBUG_CERTIFICATE $(CY_DBG_CERTIFICATE_PATH)" -c \
					"$(_MTB_RECIPE__OPENOCD_QSPI_FLASHLOADER); $(_MTB_RECIPE__OPENOCD_INTERFACE) $(_MTB_RECIPE__OPENOCD_PROBE_SERIAL) transport select $(_MTB_RECIPE__PROBE_INTERFACE); $(_MTB_RECIPE__OPENOCD_TARGET) $(_MTB_RECIPE_OPENOCD_CUSTOM_COMMAND) $(_MTB_RECIPE_OPENOCD_PROGRAM)"
_MTB_RECIPE__OPENOCD_DEBUG_ARGS=$(_MTB_RECIPE__OPENOCD_SCRIPTS) $(_MTB_RECIPE__OPENOCD_QSPI) -c "set DEBUG_CERTIFICATE $(CY_DBG_CERTIFICATE_PATH)" -c \
					"$(_MTB_RECIPE__OPENOCD_QSPI_FLASHLOADER); $(_MTB_RECIPE__OPENOCD_INTERFACE) $(_MTB_RECIPE__OPENOCD_PROBE_SERIAL) transport select $(_MTB_RECIPE__PROBE_INTERFACE); $(_MTB_RECIPE__OPENOCD_TARGET) $(_MTB_RECIPE_OPENOCD_CUSTOM_COMMAND) $(_MTB_RECIPE_OPENOCD_DEBUG)"
...
_MTB_RECIPE__JLINK_LOAD_OFFSET:=
else
