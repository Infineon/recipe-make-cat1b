...
_MTB_RECIPE__ECLIPSE_OPENOCD_DEBUG_OTHER_RUN_COMMANDS:=flushregs$(_MTB_RECIPE__ECLIPSE_NEWLINE)$(_MTB_RECIPE__ECLIPSE_OTHER_RUN_COMMANDS)
_MTB_RECIPE__ECLIPSE_OPENOCD_DEBUG_POST_TARGET_CUSTOM_COMMANDS=$(_MTB_RECIPE__ECLIPSE_NEWLINE)$(_MTB_RECIPE__ECLIPSE_POST_CONNECT_COMMANDS)


_MTB_RECIPE__ECLIPSE_OPENOCD_ATTACH_DO_CONTINUE:=true
_MTB_RECIPE__ECLIPSE_OPENOCD_ATTACH_OTHER_RUN_COMMANDS:=flushregs
_MTB_RECIPE__ECLIPSE_OPENOCD_ATTACH_PRE_TARGET_COMMANDS=$(_MTB_RECIPE__ECLIPSE_OPENOCD_PROBE_SERIAL_CMD)$(_MTB_RECIPE__ECLIPSE_OPENOCD_PROBE_INTERFACE_CMD)
...
_MTB_RECIPE__ECLIPSE_OPENOCD_ATTACH_POST_TARGET_COMMANDS+=-c $(_MTB_RECIPE__ECLIPSE_QUOT)gdb_breakpoint_override hard$(_MTB_RECIPE__ECLIPSE_QUOT)
