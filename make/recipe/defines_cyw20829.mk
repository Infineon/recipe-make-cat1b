################################################################################
# \file defines_cyw20829.mk
#
# \brief
# Definitions specific for CYW20829 devices.
#
################################################################################
# \copyright
...
# Does not support new memcalc flow.
MTB_RECIPE__MEMREPORT_SUPPORT:=

# Supported die
_MTB_RECIPE__IS_DIE_CYW20829=true

# Compatible export interfaces for CYW20829 devices
...
_MTB_RECIPE__OPENOCD_DEVICE_CFG:=infineon/cyw20829.cfg
