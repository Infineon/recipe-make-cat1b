...
recipe_eclipse_common_text_replacement_data_file:
	...
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_COMMON_TEXT_DATA_FILE),&&_MTB_RECIPE__ECLIPSE_JLINK_DEBUG_ENABLE_SEMIHOSTING&&=$(_MTB_RECIPE__ECLIPSE_JLINK_DEBUG_ENABLE_SEMIHOSTING))
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_COMMON_TEXT_DATA_FILE),&&_MTB_RECIPE__ECLIPSE_JLINK_DEBUG_ENABLE_SEMIHOSTING_GDB_CLIENT&&=$(_MTB_RECIPE__ECLIPSE_JLINK_DEBUG_ENABLE_SEMIHOSTING_GDB_CLIENT))
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_COMMON_TEXT_DATA_FILE),&&_MTB_RECIPE__ECLIPSE_JLINK_DEBUG_ENABLE_SEMIHOSTING_TELNET_CLIENT&&=$(_MTB_RECIPE__ECLIPSE_JLINK_DEBUG_ENABLE_SEMIHOSTING_TELNET_CLIENT))
...
ifneq ($(filter NON_SECURE,$(VCORE_ATTRS)),)
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_COMMON_TEXT_DATA_FILE),&&_MTB_RECIPE__ADD_SYMBOL_FILE_CMD&&=add-symbol-file $(_MTB_RECIPE__ECLIPSE_SYM_FILE)$(_MTB_RECIPE__ECLIPSE_NEWLINE))
else
ifneq (,$(_MTB_RECIPE__IS_LAST_PRJ))
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_COMMON_TEXT_DATA_FILE),&&_MTB_RECIPE__ADD_SYMBOL_FILE_CMD&&=)
endif
endif
ifneq ($(_MTB_RECIPE__APP_HEX_FILE),)
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_COMMON_TEXT_DATA_FILE),&&_MTB_RECIPE__APP_PROG_FILE_ABS&&=$(call mtb__path_normalize,$(_MTB_RECIPE__APP_HEX_FILE)))
endif
...
_MTB_RECIPE__IAR_DEVICE_NAME=$(_MTB_RECIPE__MCU_NAME)
else
_MTB_RECIPE__IAR_DEVICE_NAME=$(DEVICE)
endif

recipe_ewarm_dfp_data_file:
	$(call mtb__file_write,$(_MTB_RECIPE__IDE_DFP_DATA_FILE),DEVICE=$(_MTB_RECIPE__IAR_DEVICE_NAME)$(_MTB_RECIPE__IAR_CORE_SUFFIX))
