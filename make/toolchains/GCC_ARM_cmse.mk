...
MTB_TOOLCHAIN_GCC_ARM__LDFLAGS+=-Wl,--in-implib -Wl,$(_MTB_RECIPE__TRUSTZONE_VENEER)
endif
MTB_TOOLCHAIN_GCC_ARM__LDFLAGS+= -Wl,--out-implib -Wl,$(_MTB_RECIPE__TRUSTZONE_VENEER).tmp
endif

ifneq ($(filter TRUSTZONE_NON_SECURE,$(VCORE_ATTRS)),)
MTB_TOOLCHAIN_GCC_ARM__LDFLAGS+=$(_MTB_RECIPE__TRUSTZONE_VENEER)
endif
