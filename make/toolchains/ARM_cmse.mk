...
MTB_TOOLCHAIN_ARM__LDFLAGS+=--import-cmse-lib-in $(_MTB_RECIPE__TRUSTZONE_VENEER)
endif
MTB_TOOLCHAIN_ARM__LDFLAGS+=--import-cmse-lib-out $(_MTB_RECIPE__TRUSTZONE_VENEER).tmp
endif

ifneq ($(filter TRUSTZONE_NON_SECURE,$(VCORE_ATTRS)),)
MTB_TOOLCHAIN_ARM__LDFLAGS+=$(_MTB_RECIPE__TRUSTZONE_VENEER)
endif
